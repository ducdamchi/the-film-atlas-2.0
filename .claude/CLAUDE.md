...
The Film Atlas is a full-stack app that lets user (1) discover cinema through an interactive world map and (2) host / join screening events in their local area.
...
2. User interactions (watched, watchlisted, director tracking, ratings) are stored in the **app's PostgreSQL database** via the Express backend.
