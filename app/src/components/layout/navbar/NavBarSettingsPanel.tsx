        ...
        {authState.status ? (
          <>
            <div>
              ...
              <div
                className="hidden absolute z-20 right-0 bg-background border-atlas-blue pl-5 pb-5 pt-2 transition-all ease-out duration-200 font-light justify-end items-center"
                style={{
