...
export default function LoadingPage({
  ...
  return (
    <div className="w-[100vw] h-[200vh] top-0 flex flex-col items-center bg-page/40 absolute border-0 z-100 ">
      <div className="absolute top-[25%] w-[15rem] h-auto flex flex-col items-center justify-center p-5 drop-shadow-xl bg-background/80 text-background backdrop-blur-sm border-1  /50 rounded-md">
