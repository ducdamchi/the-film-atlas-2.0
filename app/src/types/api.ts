 ...
 * Derived from:
 *   - api/routes/Auth.js
 *   - api/routes/Watched.js   (GET /:tmdbId, POST, DELETE, PUT responses)
 *   - api/routes/Watchlisted.js  (GET /:tmdbId, POST, DELETE responses)
 *   - api/routes/Directors.js  (GET /:tmdbId response)
...
export interface SyncGuestDataResponse {
  syncedWatched: number
  syncedWatchlisted: number
}
