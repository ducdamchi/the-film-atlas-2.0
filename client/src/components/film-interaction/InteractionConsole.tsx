...
import type { StarRating, FilmInteractionRequest, FilmRateRequest, DirectorRef } from "@/types/film"
...
export default function InteractionConsole({
  ...
  function createReqBody(requestString: "like" | "save" | "rate"): FilmInteractionRequest | FilmRateRequest {
