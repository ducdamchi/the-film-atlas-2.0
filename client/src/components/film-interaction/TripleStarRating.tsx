      ...
      >
        ...
        >
          <button
            ...
            onClick={() => setRequestedRating(!showText && officialRating === 1 ? 0 : 1)}
          >
          ...
          <button
            ...
            onMouseLeave={() => setStarHover(0)}
            onClick={() => setRequestedRating(!showText && officialRating === 2 ? 0 : 2)}
          >
          ...
          <button
            ...
            onMouseLeave={() => setStarHover(0)}
            onClick={() => setRequestedRating(!showText && officialRating === 3 ? 0 : 3)}
          >
        ...
        {!showText && (officialRating ?? 0) >= 1 && (
          <div className="w-0 overflow-hidden transition-[width] duration-200 ease-out group-hover/rating:w-[0.75rem] flex items-center justify-center">
            <button
