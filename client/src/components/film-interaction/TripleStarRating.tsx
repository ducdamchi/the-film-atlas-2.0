 ...
 */
export default function TripleStarRating({ officialRating, setRequestedRating }: TripleStarRatingProps) {
  ...
  return (
    <div
      ...
      <div
        ...
        style={{
          borderColor:
            (officialRating ?? 0) >= 1 ? "oklch(65.6% 0.241 354.308)" : "var(--console-text)",
