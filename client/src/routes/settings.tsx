...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section className="border border-neutral-700 rounded-xl p-6">
      <h2 className="text-base font-semibold text-stone-200 mb-4">{title}</h2>
      {children}
    </section>
  )
}
...
function StatusMessage({
  ...
  if (success) return <p className="text-green-400 text-sm mt-2">{success}</p>
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <button
        ...
        disabled={detecting}
        className="text-sm text-stone-400 underline text-left cursor-pointer disabled:opacity-40">
...
function AccountSettings() {
  ...
  return (
    <div className="font-primary min-h-screen text-stone-900">
      <NavBar />
