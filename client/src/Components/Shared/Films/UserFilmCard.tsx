...
import LaptopInteractionConsole from "../film-interaction/LaptopInteractionConsole"
...
export default function UserFilmCard({ filmObject, queryString }: FilmUser_CardProps) {
  ...
  useEffect(() => {
    ...
    img.onload = () => {
      try {
        const domColor: [number, number, number] = getColorSync(img).array()
